...
export default function SignupPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-base bg-mesh-light dark:bg-mesh-dark px-4">
      <div className="pointer-events-none absolute left-1/4 top-1/4 h-80 w-80 animate-blob rounded-full bg-fuchsia-500/20 blur-3xl" />
      <div className="pointer-events-none absolute right-1/4 bottom-1/4 h-80 w-80 animate-blob rounded-full bg-brand-500/20 blur-3xl [animation-delay:3s]" />
      ...
      >
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-ink-muted">Start organizing your research</p>
        </div>
